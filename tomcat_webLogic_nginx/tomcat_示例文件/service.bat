set "CATALINA_HOME=D:\Workspaces\apache\apache-tomcat-7.0.56_IMS"
...
if exist "%CATALINA_HOME%\bin\tomcat7-ims.exe" goto okHome
rem CD to the upper dir
cd ..
set "CATALINA_HOME=%cd%"
:gotHome
if exist "%CATALINA_HOME%\bin\tomcat7-ims.exe" goto okHome
echo The tomcat7-ims.exe was not found...
...
set "EXECUTABLE=%CATALINA_HOME%\bin\tomcat7-ims.exe"

rem Set default Service name
set SERVICE_NAME=Tomcat7w-ims.exe
